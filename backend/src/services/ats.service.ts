import type { AtsReportPayload, ResumeData } from "../types/resume.js";
...
export function analyzeResume(data: ResumeData, jobDescription: string): AtsReportPayload {
  ...
  return { score, keywordMatch, missingKeywords, strengths, issues };
}
